...
public class DispatcherController {
	...
	public Object doLogin(String loginacct,String userpswd,String type,
		...
		try {
			...
			if("member".equals(type)){
				Object aString= paramMap.get(userpswd);
	...
	public Object doReg(String loginacct ,String userpswd,String email ,String usertype,HttpSession session,HttpServletResponse response  ){
		AjaxResult result = new AjaxResult();
		try {
		...
		Member member=memberService.saveMember1(map);
		session.setAttribute(Const.LOGIN_MEMBER, member);
		result.setSuccess(true);*/
		return result;
	}
